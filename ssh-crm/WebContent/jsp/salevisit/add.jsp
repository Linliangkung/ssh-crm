...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/SaleVisitAction-add"
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<input disabled="disabled" type="text"  style="WIDTH: 180px" id="cust_name" value="<s:property value="#saleVisit.customer.cust_name" />"/>
								...
								<td  >
									<INPUT class=textbox id="visit_time" type="text" 
														style="WIDTH: 180px" maxLength=50 name="visit_time" readonly="readonly" value="<s:date name="#saleVisit.visit_time" format="yyyy-MM-dd"/>" />
								</td>
							</TR>
							...
							<TR>
								...
								<INPUT class=textbox id="visit_nexttime" readonly="readonly"
														style="WIDTH: 180px" maxLength=50 name="visit_nexttime" value="<s:date name="#saleVisit.visit_nexttime" format="yyyy-MM-dd"/>">
								</td>
							</TR>
							<tr>
								<td rowspan=2>
								<INPUT class=button id=sButton2 type="submit"
														value="<s:property value="#saleVisit==null?'保存':'修改'" /> " name=sButton2>
								</td>
							</tr>
